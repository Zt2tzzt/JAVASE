...
Java 可变参数，底层使用数组实现，将传入的实参，会放入到一个数组中：
...
自动点名器3：班级里有 N 个学生，被点到的学生，不会再点到。如果班级中所有学生都点完了，需要重新开启第二轮点名。
...
要求1：每次被点到的学生，再次被点到的概率在原型的基础上降低一半。
...
将大项目，拆分成多个小项目，形成一个服务，每个服务又可以有服务器集群。
